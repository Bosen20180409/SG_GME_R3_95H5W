...
u8 TX_ADDRESS[TX_ADR_WIDTH]={0x20,0x16,0x09,0x20,0x11}; //发送地址
u8 RX_ADDRESS[RX_ADR_WIDTH]={0x20,0x16,0x09,0x20,0x11}; //发送地址
...
{
	u8 sta;
 	SPI1_SetSpeed(SPI_BaudRatePrescaler_32);//spi速度为9Mhz（24L01的最大SPI时钟为10Mhz）   
	NRF24L01_CE_0;
